...
from src.data_processor.core.mp_sink_utils_actual_bk import (
    get_source_df,
...
def mp_sink_bkp(ss: Session, func_args: dict, df_dict: dict) -> dict:
    """
    ...
    # Get Source Data
    source_df_xform, _ = get_source_df(
        ss, df_dict, func_args, fail_rec_table_name
    )

    source_df_xform.write.copy_into_location("@test_stage_s3/data_test.csv")
...
def mp_sink(ss: Session, func_args: dict, df_dict: dict) -> dict:
    ...
    mp_func_output = asyncio.run(send_df_to_mp(
